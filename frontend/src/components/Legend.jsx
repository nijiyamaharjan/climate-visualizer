...
function Legend({ variable, date }) {
  ...
  useEffect(() => {
    ...
    const getVariableDisplay = () => {
      switch(variable) {
        case 'tas_min': return 'Min Temperature (K)';
        case 'tas_max': return 'Max Temperature (K)';
        case 'sfc_windspeed': return 'Surface Wind Speed (m/s)';
        case 'precipitation_rate': return 'Precipitation Rate (g/m²/s)';
        case 'snowfall': return 'Snowfall (m of water equivalent)';
        case 'snowmelt': return 'Snowmelt (m of water equivalent)';
        case 'spei': return 'SPEI';
        case 'ozone': return 'Ozone (Dobson unit)';
