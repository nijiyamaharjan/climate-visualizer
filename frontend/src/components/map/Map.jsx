...
export default function Map() {
    ...
    const handleNextMonth = () => {
        ...
        if (availableYears.includes(newYear.toString())) {
                    ...
                    <SelectVariable
                        ...
                        options={[
                            ...
                            { value: "tas", label: "Average Temperature (K)" },
                            {
                                ...
                                label: "Precipitation Rate (g/m²/s)",
                            },
                            {
                            ...
                            {
                                value: "huss",
                                label: "Specific Humidity (Mass fraction)",
                            },
                            {
                                value: "snowfall",
                                label: "Snowfall (m of water equivalent)",
                            },
                            {
                                value: "snowmelt",
